...
class Settings(object):
    ...
    def setup(self,
        ...
        if cov_config is not None:
            self.cov_analysis_url = cov_config[
                'package_url'] if 'package_url' in cov_config else None
            self.cov_package_name = cov_config[
                'package_name'] if 'package_name' in cov_config else None
            self.cov_url = cov_config[
                'server_url'] if 'server_url' in cov_config else None
            self.cov_auth = cov_config[
                'auth_key'] if 'auth_key' in cov_config else None
            self.cov_package_ver = cov_config[
                'package_ver'] if 'package_ver' in cov_config else None
